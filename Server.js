...
// Express static: match actual folder name (case-sensitive on Linux/Railway)
app.use(express.static("PUBLIC"));

// (Render) Keep landing buttons working on production.
// Routes: /admin and /tv
// Note: PUBLIC/index.html already contains landing + admin UI.
...
// Database setup (Render/Vercel me robust path)
const dbPath = path.resolve(
  process.cwd(),
  process.env.DB_FILE || "hospital.db",
);
